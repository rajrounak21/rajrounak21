...
* Experience in AI/ML, backend engineering, and automation
...
A family safety platform that analyzes suspicious messages and helps users make safer decisions with trusted family members.

**Highlights**

* AI risk analysis using Groq and LangGraph
* Family-based sharing and safety verdicts
* Real-time family chat with WebSockets
...
A SaaS platform for managing students, faculty, payments, attendance, assessments, courses, analytics, and institute operations.
...
A multi-agent system that generates complete web applications from natural-language prompts.
...
A project exploring MCP-based AI systems and interactions between LLMs, agents, and external tools.
...
* Built extraction and validation logic for **vendor, amount, date, and line items**.
...
Currently expanding **Sikhsha Sathi** into a more complete and production-ready education management platform.
...
The goal is to turn Sikhsha Sathi into a useful and reliable platform for real educational institutes.
